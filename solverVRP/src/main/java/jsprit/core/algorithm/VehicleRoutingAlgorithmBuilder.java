...
//		stateManager.addStateUpdater(new OpenRouteStateVerifier());
		...
		return new VehicleRoutingAlgorithms().readAndCreateAlgorithm(vrp, algorithmConfig, nuOfThreads, solutionCostCalculator, stateManager, constraintManager, addDefaultCostCalculators);
	}
