...
public class OROutils {
	...
	public static void write(VehicleRoutingProblemSolution sol, String name, long eTime, String path,int j){
		if(sol == null) {
		...
		try {
            ...
            for(VehicleRoute r : sol.getRoutes()){
            ...
            media = somma/sol.getRoutes().size();
			/////////
			writer.write(name + ";" + df.format(sol.getRealCost()) + ";" + df.format(seconds) + ";" + sol.getRoutes().size() +";"+min+";"+max+";"+df.format(media)+";"+j+"\n");
		} catch (IOException e) {
			e.printStackTrace();
		}	
		close(writer);
	...
	public static void write(VehicleRoutingProblemSolution sol, String name, long eTime, String path){
		...
		try {
            ...
            media = somma/sol.getRoutes().size();
			/////////
			writer.write(name + ";" + df.format(sol.getRealCost()) + ";" + df.format(seconds) + ";" + sol.getRoutes().size() +";"+min+";"+max+";"+df.format(media)+"\n");
		} catch (IOException e) {
			e.printStackTrace();
		}	
		close(writer);
	...
	public static void write2(String name, String path){ 
		// Write solution on files
		BufferedWriter writer = getAppender(path);
		try {
			//writer.write("Flotta="+System.getProperty("number") + ";" + ";"  + ";" +";"+"Min act"+";"+"Max act"+";"+"Media"+"\n");
			writer.write("Flotta="+System.getProperty("number") + ";" + ";"  + ";" +";"+"Min act"+";"+"Max act"+";"+"Media"+";"+"ripetizioni"+"\n");
		} catch (IOException e) {
			e.printStackTrace();
		}	
		close(writer);
